...
=======================
Run from your KG-Trace/ directory:
...
print(f"{BOLD}Done. The fix is in model/kg_trace.py — make gene_attn query-conditioned on genomic features.{RST}\n")
