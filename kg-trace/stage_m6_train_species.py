"""
Stage M6: Train KG-Trace Per Species
Trains a separate KGTrace model for each species using the phylogenetic CV folds.
...
from paths import PROJECT_DIR, MENDELEY_DIR, KG_EMBED_DIM
...
CV_BASE    = os.path.join(MENDELEY_DIR,
