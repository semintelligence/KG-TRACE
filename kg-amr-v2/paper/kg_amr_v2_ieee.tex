...
A growing body of work applies machine learning to WGS-derived features for AMR prediction. \tbd{Cite and discuss relevant works, e.g., approaches using k-mer features, binary mutation matrices, random forests, SVMs, gradient-boosted trees, and deep learning for AMR classification. Include citations to CRyPTIC consortium publications and WHO mutation catalogue work.}
